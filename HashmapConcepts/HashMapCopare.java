...
public class HashMapCopare {
	...
	public static void main(String[] args) {
		...
		//2. compare hashmap for the same keys:ketSet()
		...
		//combine the keys from both the hashmap: using hashset
		HashSet<Integer> combineKeys=new HashSet<Integer>(map1.keySet());
		//add all the keyset from map4 also
